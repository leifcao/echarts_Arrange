...
//疫情入汉图
var mapImmigrate = document.getElementById('mapImmigrate');
var mapImmigrateEchart = echarts.init(mapImmigrate);
...
var ImmigrationSeries = [];
[
  ["武汉", SHData]
].forEach(function(item, i) {
  ImmigrationSeries.push({
      type: "lines",
      zlevel: 2,
      effect: {
        show: true,
...
let mapImmigrateOption = {
  ...
  series: ImmigrationSeries
};

mapImmigrateEchart.setOption(mapImmigrateOption);
