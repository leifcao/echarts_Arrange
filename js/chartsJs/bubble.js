...
//气泡图1
let bubbleOnedatas1 = [
  {'name': 'SCI', value: [4500, 60.3, 100], '发表论文总数': 4500, '人均发表篇次': 60.3, '总被引用次数': 100},
  {'name': 'SSCI', value: [4500, 40, 120], '发表论文总数': 4500, '人均发表篇次': 40, '总被引用次数': 120},
  {'name': 'EI', value: [11000, 25, 200], '发表论文总数': 11000, '人均发表篇次': 25, '总被引用次数': 200},
  {'name': 'ISTP', value: [14000, 40, 250], '发表论文总数': 14000, '人均发表篇次': 65, '总被引用次数': 250},
  {'name': 'AHCI', value: [15000, 40, 400], '发表论文总数': 15000, '人均发表篇次': 40, '总被引用次数': 400},
  {'name': 'ISSHP', value: [20000, 66, 300], '发表论文总数': 20000, '人均发表篇次': 66, '总被引用次数': 300},
  {'name': '其他', value: [20121, 75, 280], '发表论文总数': 20121, '人均发表篇次': 75, '总被引用次数': 280},
]
let bubbleOnedatas2 = [
  {'name': 'SCI', value: [5000, 65.3, 30], '发表论文总数': 5000, '人均发表篇次': 65.3, '总被引用次数': 30},
  {'name': 'SSCI', value: [6000, 40, 50], '发表论文总数': 6000, '人均发表篇次': 40, '总被引用次数': 50},
  {'name': 'EI', value: [12000, 82, 60], '发表论文总数': 12000, '人均发表篇次': 82, '总被引用次数': 60},
  {'name': 'ISTP', value: [16000, 45, 350], '发表论文总数': 16000, '人均发表篇次': 45, '总被引用次数': 350},
  {'name': 'AHCI', value: [15000, 30, 500], '发表论文总数': 15000, '人均发表篇次': 30, '总被引用次数': 500},
  {'name': 'ISSHP', value: [18000, 66, 280], '发表论文总数': 18000, '人均发表篇次': 72, '总被引用次数': 280},
  {'name': '其他', value: [27121, 75, 270], '发表论文总数': 27121, '人均发表篇次': 80, '总被引用次数': 270},
]
//气泡图1
let bubblesOneData = {
  id: 'bubblesFirst',
