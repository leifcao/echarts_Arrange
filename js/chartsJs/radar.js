...
radarOneOption = {
    ...
    radar: {
        ...
        splitLine: {
            lineStyle: {
                width: 1,
                color: ['rgba(115,115,115, 0.3)'].reverse()
            }
        }
    },
    series: [{
...
radarThreeOption = {
    ...
    radar: {
        ...
        shape: 'circle',
        splitNumber: 5, //设置有多少个圈

        name: { textStyle: { color: textColor, fontSize: '12', borderRadius: 3, padding: [3, 5] } },
        nameGap: '2',
        splitLine: {
            lineStyle: {
                color: [
                    'rgba(40,255,179, 0.1)', 'rgba(40,255,179, 0.2)',
                    'rgba(40,255,179, 0.4)', 'rgba(40,255,179, 0.6)',
                    'rgba(40,255,179, 0.8)', 'rgba(40,255,179, 1)' //背景线条颜色
                ].reverse()
            }
        },
        splitArea: {
        ...
        axisLine: {
            lineStyle: {
                color: 'rgba(40,255,179, 0.4)' //大线条颜色
            }
        }
    },
    series: [{
