...
//仪表盘2
var getfpkszb = [{name: '非贫困生', value: 62.35, total: 1265}];//非贫困生占比

//贫困生分布-非贫困生图表
let dashboardFiveOption = {
  title: {
    text: getfpkszb[0].value + '%',
    textStyle: {
      color: '#34E3EA',
      fontSize: 18
    },
  ...
  tooltip: {
    formatter: function (params) {
      return '<span style="color: #fff;">非贫困生人数：' + params.data.total + '人</span>';
    }
  },
  angleAxis: {
    max: 100,
...
var dashboardFifth = initEcharts('dashboardFifth');
dashboardFifth.setOption(dashboardFiveOption);
