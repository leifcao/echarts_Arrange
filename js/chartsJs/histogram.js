...
let hisogramFourData = {
  id: 'histogramFourth',
  legend: ['支出', '收入'],
  xAxis: ["11月1日", "11月2日", "11月3日", "11月4日", "11月5日", "11月6日", "11月7日", "11月8日", "11月9日"],
  seriesData: [
    {name: '辅助', type: 'bar', data: [0, 900, 1245, 1530, 1376, 1376, 1511, 1856, 1495]},
    {name: '收入', type: 'bar', data: [900, 345, 393, '', '', 500, 400, '', '']},
    {name: '支出', type: 'bar', data: ['', '', '', 300, 400, '', '', 550, 361]},
  ]
}
...
// 3d柱状图
var histogramSixData = {
  id: 'histogramSixth',
  xAxis: ['数据可视化', '商业智能', '区块链', '数据挖掘', '人工智能'],
  seriesData: [{name: '2019', type: 'bar', data: [1000, 600, 800, 700, 550], symbol: "circle"}]
}

//3d柱状图 - 波纹ripple
var histogramSevenData = {
  id: 'histogramSeventh',
  xAxis: ['制造业', '建筑业', '农林牧渔', '房地产', '金融业'],
  seriesData: [{name: '2019', type: 'bar', data: [4000, 2600, 1300, 1300, 1250], symbol: "circle", target: 3500}]
}
...
var histogramEightData = {
  ...
  seriesData: [{name: '在线情况', type: 'bar', data: [500, 300, 200, 350, 250], symbol: "circle", max: 500}]
}

//3d柱状图 - 方形
var histogramNineData = {
  id: 'histogramNinth',
  xAxis: ['制造业', '建筑业', '农林牧渔', '房地产', '金融业'],
  seriesData: [{name: '2019', type: 'bar', data: [4000, 2600, 1300, 1300, 1250], symbol: "diamond"}]
}
...
var histogramTenData = {
  id: 'histogramTenth',
  xAxis: ['立春', '春分', '立夏', '夏至'],
  seriesData: [{name: '在线情况', type: 'bar', data: [200, 300, 150, 120], symbol: "diamond", max: 300}]
}
...
// 3d柱状图
let histogramSix_data = dataFormat(histogramSixData, 'columnar3d')
let histogramSixth = new BarEchart(GetOpiton(histogramSix_data, histogramOption()));

//3d柱状图 - 波纹ripple
let histogramSeven_data = dataFormat(histogramSevenData, 'columnar3d_ripple')
let histogramSeventh = new BarEchart(GetOpiton(histogramSeven_data, histogramOption()));
...
//3d柱状图 - 方形
let histogramNinth_data = dataFormat(histogramNineData, 'columnar3d')
let histogramNinth = new BarEchart(GetOpiton(histogramNinth_data, histogramOption()));
